// app/src/repositories/interfaces/cart-item.repository.interface.ts
...
export interface ICartItemRepository {
   ...
   */
  create(data: CartItemCreationAttributes, transaction?: Transaction): Promise<CartItem>;
   ...
   */
  destroy(cartItem: CartItem, transaction?: Transaction): Promise<void>;
}
