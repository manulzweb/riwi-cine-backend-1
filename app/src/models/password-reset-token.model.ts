...
export type { BaseTokenAttributes as PasswordResetTokenAttributes } from './common/base-token-schema.js';
export type { BaseTokenCreationAttributes as PasswordResetTokenCreationAttributes } from './common/base-token-schema.js';
